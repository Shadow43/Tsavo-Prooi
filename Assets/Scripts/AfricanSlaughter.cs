...
public class AfricanSlaughter : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            string startTextState = "<color=#e02046>\"That blasted lion.\"</color><color=#d3cbcb> You mutter to yourself. </color><color=#e02046>\"Slaughtered the African Tribe.\"</color>";
